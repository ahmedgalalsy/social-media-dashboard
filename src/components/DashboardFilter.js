...
import { Box, FormControl, InputLabel, Select, MenuItem, TextField, Button, Grid, Chip, IconButton } from '@mui/material';
      ...
      <Box sx={{ 
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: expanded ? 2 : 0 }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Box component="span" sx={{ fontWeight: 'medium' }}>Filters</Box>
          </Box>
          <Button 
            variant="text" 
            color="primary" 
